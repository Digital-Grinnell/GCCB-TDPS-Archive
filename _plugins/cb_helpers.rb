  ...
  class Generator < Jekyll::Generator
    ...
    def generate(site)
      ...
      if featured_image.include? "/"
        ...
        featured_item_alt = site.data['theme']['featured-image-alt-text'] || site.config['dc_title']
        ...
        if site.data[site.config['metadata']]
          ...
          if featured_record.empty?
            ...
            featured_item_alt = featured_record[0]['image_alt_text'] || featured_record[0]['dc_title'] || site.config['dc_title']
